...
const Footer = () => {
    return (
        <footer className="bg-slate-950 pt-20 pb-10 border-t border-white/5 relative overflow-hidden">
            {/* Abstract shapes */}
            <div className="absolute top-[-50%] left-[-20%] w-[1000px] h-[1000px] bg-purple-900/10 rounded-full mix-blend-screen filter blur-[100px] pointer-events-none"></div>

            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    {/* Brand */}
                    <div>
                        <Link to="home" smooth={true} duration={500} className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500 mb-4 inline-block cursor-pointer">
                            ServiceWala
                        </Link>
                        ...
                        <div className="flex space-x-4">
                            ...
                            <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:bg-indigo-500 hover:text-white transition-all">
                                <Linkedin size={20} />
                            </a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li><a href="#" className="text-gray-400 hover:text-purple-400 transition-colors">App Development</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-purple-400 transition-colors">UI/UX Design</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-purple-400 transition-colors">Custom Software</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-purple-400 transition-colors">Digital Marketing</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li><a href="#" className="text-gray-400 hover:text-purple-400 transition-colors">Portfolio</a></li>
